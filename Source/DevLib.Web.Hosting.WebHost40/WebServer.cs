...
namespace DevLib.Web.Hosting.WebHost40
{
    ...
    using System.Xml;
    using DevLib.Web.Hosting.WebHost40.NativeAPI;
    using DevLib.Web.Hosting.WebHost40.Properties;
    ...
    public class WebServer : MarshalByRefObject, IDisposable
    {
        ...
        /// </summary>
        private static readonly string RootWebConfigPath = Environment.ExpandEnvironmentVariables(@"%windir%\Microsoft.Net\Framework\v4.0.30319\config\web.config");
...
#else
            bool isSupportsIPv4 = Socket.OSSupportsIPv4;
#endif
