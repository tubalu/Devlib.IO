...
namespace System.Linq
{
    public static class ParallelEnumerable
    {
        ...
        private static TSource SingleInternal<TSource>(this ParallelQuery<TSource> source, params TSource[] init)
        {
            TSource result = default(TSource);
            bool hasValue = false;
        ...
        private static T BestOrder<T>(ParallelQuery<T> source, Func<T, T, bool> bestSelector, T seed)
        {
            if (source == null)
                throw new ArgumentNullException("source");
